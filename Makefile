# This Makefile is for the CCCP::Encode extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/CCCP/Encode.pm]
#     AUTHOR => q[Ivan Sivirinov]
#     NAME => q[CCCP::Encode]
#     PREREQ_PM => { Text::Unidecode=>q[0], HTML::Entities=>q[0], Carp=>q[0], Encode=>q[0] }
#     VERSION_FROM => q[lib/CCCP/Encode.pm]
...
PARENT_NAME = CCCP
DLBASE = $(BASEEXT)
VERSION_FROM = lib/CCCP/Encode.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CCCP/Encode.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/CCCP
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/CCCP
...
TO_INST_PM = lib/CCCP/Encode.pm

PM_TO_BLIB = lib/CCCP/Encode.pm \
...
DISTNAME = CCCP-Encode
DISTVNAME = CCCP-Encode-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CCCP/Encode.pm $(INST_MAN3DIR)/CCCP::Encode.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               CCCP-Encode' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Text::Unidecode:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Text::Unidecode" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CCCP/Encode.pm blib/lib/CCCP/Encode.pm 
